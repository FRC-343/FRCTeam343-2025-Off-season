...
public record SimCameraConfig(Calibration calib, CalibrationError calibError, Latency latency) {
  ...
  public static SimCameraConfig ARDUCAM_OV9281_70 =
      new SimCameraConfig(
          new Calibration(1280, 720, Rotation2d.fromDegrees(70), 90),
          new CalibrationError(0.25, 0.08),
          new Latency(20, 5));

  public static SimCameraConfig ARDUCAM_OV9281_80 =
      new SimCameraConfig(
          new Calibration(1280, 720, Rotation2d.fromDegrees(80), 90),
          new CalibrationError(0.25, 0.08),
          new Latency(20, 5));
}
